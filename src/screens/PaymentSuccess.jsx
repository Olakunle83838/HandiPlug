  ...
  return (
    <div className="bg-white flex flex-col h-full w-full">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 gap-6 text-center">
        <div className="border border-[#E5E7EB] rounded-2xl w-full p-8 flex flex-col items-center gap-5">
          ...
          <p className="text-[#6B7280] text-sm">
            &ldquo;Money don release to Musa since job don complete well well. E don enter him
            wallet&rdquo;
          </p>
          ...
          <div className="flex gap-3 w-full">
            ...
            <button
              ...
              className="flex-1 h-11 rounded-[10px] bg-[#FF7A00] text-white text-sm font-medium flex items-center justify-center gap-1"
            >
              ✍️ Leave a Review
            </button>
          </div>
