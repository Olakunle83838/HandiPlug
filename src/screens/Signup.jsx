...
export default function Signup() {
  ...
  const Form = () => (
    <>
      ...
      <TextInput
        label="Home Address"
        placeholder="Lagos Island, Lagos State"
        value={form.address}
  ...
  return (
    <div className="bg-white flex flex-col h-full w-full">
        ...
        <div className="flex flex-col gap-4 px-6 pt-[39px] pb-6">
          ...
          <div className="flex gap-1.5 items-center justify-center pt-1">
            ...
            <button
              ...
              className="text-[#1C4CD1] text-sm font-semibold"
            >
              Log In
            </button>
          </div>
      ...
      <div className="hidden md:flex md:h-full md:w-full">
        <div className="w-1/2 bg-[#1C4CD1] flex flex-col items-center justify-center px-16 gap-6">
        ...
        <div className="w-1/2 overflow-y-auto flex items-center justify-center px-16 py-10">
          <div className="w-full max-w-[440px] flex flex-col gap-5">
            ...
            <p className="text-[#6B7280] text-sm -mt-2">
              Join Lagos&rsquo;s trusted artisan community
            </p>
            <TogglePill
              options={["I'm a Customer", "I'm an Artisan"]}
              active={role}
